...
function simple_php_captcha($config = array()) {
	...
	//$image_src = substr(__FILE__, strlen($_SERVER['DOCUMENT_ROOT'])) . '?_CAPTCHA&amp;t=' . urlencode(microtime()); // ***** pas satisfaisant ***** /htdocs/serv/jack/uno/plugins/contact/simple-php-captcha/simple-php-captcha.php?_CAPTCHA&amp;t=0.05574500+1404040932
	$image_src = dirname($_SERVER['PHP_SELF']) . '/simple-php-captcha/simple-php-captcha.php?_CAPTCHA&amp;t=' . urlencode(microtime()); // OK
