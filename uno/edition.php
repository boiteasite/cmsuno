...
<script type="text/javascript" src="<?php if($Udep=='uno/') echo 'uno/includes/js/jquery-3.2.1.min.js'; else echo '//ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js';?>"></script>
